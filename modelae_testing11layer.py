# -*- coding: utf-8 -*-
"""modelAE_testing11Layer

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/15ZHzH9yj3nk4JZG6XBrVCwGIW52TqRXO
...
modelAEtesting = modelAE.to(device)
modelAEtesting.eval()

# Check the device for the model parameters
next(modelAEtesting.parameters()).device
...
with torch.no_grad():
    for images, labels in tqdm(dataloader, desc='Processing images'):
        ...
        features = modelAEtesting.encoder(images)
...
# Save the figure
fig.savefig('/content/drive/MyDrive/BerkasKuliah/Skripsi/hasil_testing/HasilGambar/AEgambarepoch70_testing_15cluster(1).png')
...
# Save the figure
fig.savefig('/content/drive/MyDrive/BerkasKuliah/Skripsi/hasil_testing/HasilGambar/AEgambarepoch70_testing_15cluster.png')
...
file_path = os.path.join(folder_path, 'clusteringAE_testing_epoch_70_15cluster.xlsx')
...
df.to_csv('/content/drive/MyDrive/BerkasKuliah/Skripsi/hasil_testing/cluster_labels_70_testing_15cluster_AE.csv', index=False)

# Membaca file cluster_labels dengan encoding yang sesuai
file_path = '/content/drive/MyDrive/BerkasKuliah/Skripsi/hasiltrain/HasilDatapercluster/ModelAE_Hasil/label_cluster(15)_70_AEtrain.xlsx'
df_train = pd.read_excel(file_path)

# Membaca file cluster_labels_epoch30_testing.csv
file_path_testing = '/content/drive/MyDrive/BerkasKuliah/Skripsi/hasil_testing/cluster_labels_70_testing_15cluster_AE.csv'
...
if comparison.all():
    ...
    print("Hasil pelabelan pada data testing berbeda dengan hasil pelabelan pada data training.")
...
folder_path = '/content/drive/MyDrive/BerkasKuliah/Skripsi/hasil_testing/Akurasi/AkurasiAE'
...
# Menyimpan DataFrame ke dalam file Excel
output_path = '/content/drive/MyDrive/BerkasKuliah/Skripsi/hasil_testing/EvaluasiClustering/ClusteringAE/Evalcluster_epoch70_(15cluster)_AE.xlsx'
